...
//            queryWrapper.eq("o.id", currentUser.getStoreId());
            //按卖家查询
            queryWrapper.eq(CharSequenceUtil.equals(currentUser.getRole().name(), UserEnums.STORE.name()), "o.buyer_id", currentUser.getStoreId());

            //店铺查询
            queryWrapper.eq(CharSequenceUtil.equals(currentUser.getRole().name(), UserEnums.MANAGER.name())
                    && CharSequenceUtil.isNotEmpty(storeId), "o.buyer_id", storeId);
